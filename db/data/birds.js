...
const birds2 = [
  ...
  // }
  {
    ...
    location: { lat: 55.5512068, lon: -4.6363114 },
    img_url:
      'https://upload.wikimedia.org/wikipedia/commons/5/5e/Larus-fuscus-taxbox.jpg',
    features: { wingspan: 140, chest: 'white', back: 'black', head: 'white' }
  },
  {
    user_id: 'Neighbourhoot',
    bird_name: 'Eurasian Blue Tit',
    location: { lat: 51.7762515, lon: -0.0159873 },
    img_url:
      'https://upload.wikimedia.org/wikipedia/commons/8/86/Eurasian_blue_tit_Lancashire.jpg',
    features: { wingspan: 18, chest: 'yellow', back: 'blue', head: 'blue' }
  },
  {
    user_id: 'Neighbourhoot',
    bird_name: 'Eurasian Collared-Dove',
    ...
    features: { wingspan: 51, chest: 'grey', back: 'grey', head: 'grey' }
  },
  {
    user_id: 'Neighbourhoot',
    bird_name: 'Common Chiffchaff',
    location: { lat: 51.832343, lon: -0.603903 },
    img_url:
      'https://upload.wikimedia.org/wikipedia/commons/c/cc/Chiffchaff_-_Phylloscopus_collybita.jpg',
    features: { wingspan: 17, chest: 'cream', back: 'brown', head: 'brown' }
  },
  {
    user_id: 'Neighbourhoot',
    bird_name: 'Yellowhammer',
    location: { lat: 51.832343, lon: -0.603903 },
    img_url:
      'https://upload.wikimedia.org/wikipedia/commons/6/62/Goldammer_Emberiza_citrinella.jpg',
    features: { wingspan: 26, chest: 'yellow', back: 'brown', head: 'yellow' }
  }
];
